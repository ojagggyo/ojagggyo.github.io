...
async function main_0(){
    ...
    fetch("https://api.wise.com/v1/rates?source=JPY&target=KRW&from=" + from.toLocaleDateString().replace("/","-") + "&to=" + to.toLocaleDateString().replace("/","-") + "&group=minute", requestOptions)
      .then(
